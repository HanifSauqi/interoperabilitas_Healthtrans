<template>
  <aside
    id="default-sidebar"
    class="fixed z-20 left-0 w-240 h-screen bg-white flex flex-col justify-between"
    aria-label="Sidenav"
  >
    <div>
      <h1 class="text-2xl font-nunito text-center p-4">
        <span class="text-red-500 font-bold">Health</span>
        <span class="text-blue-500 font-bold">trans</span>
      </h1>
      ...
      <router-link
        ...
        :class="{ 'bg-white text-black': $route.path !== '/ambulans' }"
      >
        <svg
          ...
          height="1em"
          viewBox="0 0 256 256"
          class="fill-current h-6 w-6 mr-4 ml-2"
        >
          <path
            fill="currentColor"
      ...
      <router-link
        to="/pertolongan-pertama"
        class="block mt-4 py-3 mx-6 rounded-lg flex items-center hover:bg-blue-500 hover:text-white hover:border-blue-500"
        active-class="bg-blue-500 text-white border-blue-500"
        :class="{ 'bg-white text-black': $route.path !== '/pertolongan-pertama' }"      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1em"
          height="1em"
      ...
      <router-link
        ...
        class="block mt-4 py-3 mx-6 rounded-lg flex items-center hover:bg-blue-500 hover:text-white hover:border-blue-500"
        active-class="bg-blue-500 text-white border-blue-500"
        :class="{ 'bg-white text-black': $route.path !== '/riwayat' }"      
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1em"
        ...
        >
          <path
            fill="currentColor"
            d="M10 4a6 6 0 1 1-5.996 5.777a.75.75 0 1 0-1.499-.054A7.5 7.5 0 1 0 5 4.41V3.25a.75.75 0 0 0-1.5 0v3c0 .414.336.75.75.75h3a.75.75 0 0 0 0-1.5H6.031A5.98 5.98 0 0 1 10 4m.5 2.25a.75.75 0 0 0-1.5 0v4c0 .414.336.75.75.75h3a.75.75 0 0 0 0-1.5H10.5z"
          />
        </svg>
        Riwayat
      </router-link>
    ...
    <div class="border-t border-gray-200 overflow-y-auto py-5">
      <router-link
        ...
        class="block mt-4 py-3 mx-6 rounded-lg flex items-center hover:bg-blue-500 hover:text-white hover:border-blue-500"
        active-class="bg-blue-500 text-white border-blue-500"
        :class="{ 'bg-white text-black': $route.path !== '/settings' }"      
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1em"
